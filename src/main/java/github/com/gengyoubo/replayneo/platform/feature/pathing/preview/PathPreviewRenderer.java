...
public class PathPreviewRenderer extends EventRegistrations {
    ...
    private static int interpolateColor(double weight) {
        return (interpolateColorComponent((github.com.gengyoubo.replayneo.platform.feature.pathing.preview.PathPreviewRenderer.SLOW_PATH_COLOR >> 16) & 0xff, (github.com.gengyoubo.replayneo.platform.feature.pathing.preview.PathPreviewRenderer.FAST_PATH_COLOR >> 16) & 0xff, weight) << 16)
                | (interpolateColorComponent((github.com.gengyoubo.replayneo.platform.feature.pathing.preview.PathPreviewRenderer.SLOW_PATH_COLOR >> 8) & 0xff, (github.com.gengyoubo.replayneo.platform.feature.pathing.preview.PathPreviewRenderer.FAST_PATH_COLOR >> 8) & 0xff, weight) << 8)
                | interpolateColorComponent(github.com.gengyoubo.replayneo.platform.feature.pathing.preview.PathPreviewRenderer.SLOW_PATH_COLOR & 0xff, github.com.gengyoubo.replayneo.platform.feature.pathing.preview.PathPreviewRenderer.FAST_PATH_COLOR & 0xff, weight);
    }
