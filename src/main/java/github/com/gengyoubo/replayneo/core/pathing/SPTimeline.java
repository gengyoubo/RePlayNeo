...
public class SPTimeline implements PathingRegistry {
    private static final Logger LOGGER = LogManager.getLogger(SPTimeline.class);
    ...
    private String serializeInterpolator(Interpolator interpolator) {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to serialize interpolator: " + interpolator, e);
        }
    ...
    private Interpolator deserializeInterpolator(String json) {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to deserialize interpolator: " + json, e);
        }
    }
}
